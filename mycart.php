  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      addToCartButton.addEventListener('click', function() {
        ...
        console.log('Added to Cart. Quantity:', selectedQuantity);
      });
    });

    function addToCart(foodItemId) {
      var quantityInput = document.getElementById(foodItemId).querySelector('.quantity-input');
      var selectedQuantity = parseInt(quantityInput.value);

      document.querySelector('input[name="foodItemId"]').value = foodItemId;
